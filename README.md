...
- Exact code head: `3eb142db43a5002bfb10a0cc56fabd851a9c8ac7`
- Captured at: `2026-08-20T20:34:23Z`
...
The parent-head reproduction ran the same focused unit scenario and failed three command-routing cases (`12/15` passed). The exact head passed all `15/15` cases.
