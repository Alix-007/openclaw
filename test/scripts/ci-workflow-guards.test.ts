...
`,
  ...
  it("gates current Control UI changes on ordinary and real-Gateway Chromium E2E", () => {
    ...
    expect(realGatewayRuns).toEqual([
      ...
      "node scripts/run-vitest.mjs run --config test/vitest/vitest.ui-e2e.config.ts --configLoader runner ui/src/e2e/cron-conversation-targets-real-gateway.e2e.test.ts",
